...
export const POSTCODE_META: Record<string, { name: string; slug: string; state: string }> = {
  ...
  "2205": { name: "Arncliffe",      slug: "arncliffe-2205",      state: "NSW" },
  ...
  "3977": { name: "Cranbourne",     slug: "cranbourne-3977",     state: "VIC" },
  "3150": { name: "Glen Waverley",  slug: "glen-waverley-3150",  state: "VIC" },
  ...
  "4032": { name: "Chermside",      slug: "chermside-4032",      state: "QLD" },
  "4500": { name: "Brendale",       slug: "brendale-4500",       state: "QLD" },
  ...
  "5000": { name: "Adelaide CBD",    slug: "adelaide-5000",       state: "SA" },
  "5045": { name: "Glenelg",        slug: "glenelg-5045",        state: "SA" },
