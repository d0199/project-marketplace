...
export default function BlogIndex({ posts }: Props) {
  ...
  return (
    <>
      <Head>
        <title>Gym & Fitness Resources — mynextgym.com.au</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="Gym & Fitness Resources — mynextgym.com.au" />
        ...
        <meta name="twitter:title" content="Gym & Fitness Resources — mynextgym.com.au" />
