          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            {initialEmail ? (
              ...
              <p className="text-xs text-gray-500 bg-gray-50 rounded-lg px-3 py-2">
                ...
                <Link href={`/owner?redirect=${encodeURIComponent(`${gymUrl(gym)}?claim=true`)}`} className="text-brand-orange hover:underline font-medium">
                  Sign in first
                </Link>{" "}
            ...
            <div>
              ...
              {emailExists && (
                <div className="mt-1.5 text-xs text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
                  ...
                  <Link href={`/owner?redirect=${encodeURIComponent(`${gymUrl(gym)}?claim=true`)}`} className="text-brand-orange hover:underline font-semibold">
                    Sign in
                  </Link>{" "}
