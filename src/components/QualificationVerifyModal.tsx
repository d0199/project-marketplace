        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            <p className="text-sm text-gray-500">
              Submit evidence of your qualifications for verification. This can include
              certificate numbers, issuing bodies, or links to verification portals.
            </p>
            ...
            <p className="text-xs text-gray-400">
              File uploads coming soon. For now, please provide certificate details or links to online verification portals.
            </p>
